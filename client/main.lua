...
Citizen.CreateThread(function()
    ...
    exports['qb-target']:AddBoxZone("mrdp_change_picture", vector3(439.44, -985.89, 34.97), 1.0, 0.4, {
        ...
        options = {
            {
                type = "client",
                event = "mr-whiteboard:changewhiteboardurl",
                icon = "fa fa-camera",
                label = "Change Image",
                job = "police",
            },
...
AddEventHandler("mr-whiteboard:changewhiteboardurl", function()
    ...
    if link then
        TriggerServerEvent("mr-whiteboard:changewhiteboard", link, 'classroom')
    end
end)

RegisterNetEvent("mr-whiteboard:changewhiteboardcli", function(pUrl, pRoom)
